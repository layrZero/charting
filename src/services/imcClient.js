...
export class ImcClient {
  ...
  marketTimings(date, options) { return this.request('market/timings', { date }, options); }
  marketHolidays(year, options) { return this.request('market/holidays', year ? { year } : {}, options); }
