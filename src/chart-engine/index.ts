...
// ('@layr0/chart-engine/webgl') and `renderer: 'auto'` picks it up. Nothing under
...
// indicator registry (built-in descriptors ship in '@layr0/chart-engine/indicators')
export {
  registerIndicator,
  getIndicator,
  hasIndicator,
...
// Family-B transforms live in the lazy '@layr0/chart-engine/transform' entry point
