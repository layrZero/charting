...
// '@layr0/chart-engine' external: a relative import of the chart-type registry
...
import { getChartType, registeredChartTypes, registerRenderBackend } from '@layr0/chart-engine';
...
export class WebGL2Backend implements IRenderBackend {
  ...
  public mount(canvas: HTMLCanvasElement, ctx2d: CanvasRenderingContext2D | null): void {
    ...
    if (this._ctx === null) throw new Error('@layr0/chart-engine: 2D canvas context is not available');
